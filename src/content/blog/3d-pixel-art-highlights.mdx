...
thumbnail:
  ...
  alt: Pixel-art segment grid texture used as a thumbnail for the outline article
---
...
import ArticleInsetMask from "../../components/ArticleInsetMask.astro";
import ArticleSegmentFieldTexture from "../../components/ArticleSegmentFieldTexture.astro";
import ArticleIndentedSegmentBoundaries from "../../components/ArticleIndentedSegmentBoundaries.astro";
import ArticleIndentedSegmentBoundariesOrbit from "../../components/ArticleIndentedSegmentBoundariesOrbit.astro";
import ArticleInsetWorldNormals from "../../components/ArticleInsetWorldNormals.astro";
import ArticleInsetNdotLLighting from "../../components/ArticleInsetNdotLLighting.astro";
import ArticleAppliedInsetShading from "../../components/ArticleAppliedInsetShading.astro";
import ArticleAppliedInsetShadingOrbit from "../../components/ArticleAppliedInsetShadingOrbit.astro";
import ArticleAppliedInsetShadingPointLights from "../../components/ArticleAppliedInsetShadingPointLights.astro";
import ArticleEverythingTogetherScene from "../../components/ArticleEverythingTogetherScene.astro";
import ArticleEverythingTogetherPointLightsScene from "../../components/ArticleEverythingTogetherPointLightsScene.astro";
import Note from "../../components/Note.astro";
import SegmentMapNote from "../../components/SegmentMapNote.astro";

One of the defining characteristics of traditional pixel art is crisp, single-pixel thick outlines. When trying to achieve this effect with 3D geometry, simple outline methods like the <a href="https://bnpr.gitbook.io/bnpr/outline/inverse-hull-method" target="_blank" rel="noreferrer">inverse-hull method</a> lead to outlines with varying pixel widths, which doesn't lend well to capturing the pixel art aesthetic.
...
Another bit of detail we can add in is "segment" highlights. I read about this from <a href="https://starbi.dev/#empty-spaces" target="_blank" rel="noreferrer">starbi's amazing writeup</a> on a 3D recreation of a pixel art piece. They explained a clever approach to achieving "pixel-perfect lines on mesh surfaces", calling it <b>segment edge detection</b>.
...
<CodeWindow title="UV-Space To World-Space Normals" language="HLSL (pseudocode)">
...
<ArticleEverythingTogetherScene />

<ArticleEverythingTogetherPointLightsScene />

# Resources

- "Creating a Pixel Art Scene in Realtime 3D" by t3ssel8r: https://imgur.com/gallery/creating-pixel-art-scene-realtime-3d-qwhbHQq
- "Empty Spaces" by starbi: https://starbi.dev/#empty-spaces
