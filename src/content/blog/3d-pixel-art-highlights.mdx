...
Now that we have the segment inset mask, we want to choose which "side" of the inset mask to use for our indented normal. We will use the surface normal and light direction [... idk yet]

<Note variant="primary" title="Site under construction">
  If you're reading this, I'm working on finishing this up! doing indented
